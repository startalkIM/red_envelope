...
class AlipayCertClientConfig(object):
    ...
    def certPath(self, value):
        self._certPath = value

    @property
    def AlipayPublicCertPath(self):
        return self._AlipayPublicCertPath

    @AlipayPublicCertPath.setter
    def AlipayPublicCertPath(self, value):
        self._AlipayPublicCertPath = value

    @property
    def RootCertPath(self):
        return self._RootCertPath

    @RootCertPath.setter
    def RootCertPath(self, value):
        self._RootCertPath = value
